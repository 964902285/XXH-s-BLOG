...
project = u'XXH\'s BLOG' 
copyright = u'2018, 人生苦短，我选python'
...
latex_documents = [
  ('index', 'python3-cookbook.tex', u'《自学Python之路》',
   u'人生苦短，我选python', 'howto'),
]
...
man_pages = [
    ('index', 'python3-cookbook', u'《自学Python之路》',
     [u'人生苦短，我选python'], 1)
]
...
texinfo_documents = [
  ('index', 'Python-Time', u'《自学Python之路》',
   u'人生苦短，我选python', 'Python-Time', '《自学Python之路》',
   'Miscellaneous'),
]
